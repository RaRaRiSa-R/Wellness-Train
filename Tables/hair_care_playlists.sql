...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 31, 2022 at 01:47 PM
...
--
-- Table structure for table `hair care playlists`
--

CREATE TABLE `hair care playlists` (
  `SNo.` int(10) NOT NULL,
...
--
-- Dumping data for table `hair care playlists`
--

INSERT INTO `hair care playlists` (`SNo.`, `ScId`, `Language`, `Name`, `link`) VALUES
...
--
-- Indexes for table `hair care playlists`
--
ALTER TABLE `hair care playlists`
  ADD PRIMARY KEY (`SNo.`);
...
--
-- AUTO_INCREMENT for table `hair care playlists`
--
ALTER TABLE `hair care playlists`
