<?php
    session_start();
    $_SESSION['current_page'] = "exercise_playlist.php?id={$_GET['id']}";
?>
<?php
    require('connection_login.php');
    $sql="SELECT * FROM exercise WHERE sno={$_GET['id']}";
    ...
    <section id="playlist">
        <div class="main-description">
            ...
            <?php
                ...
                $sql="SELECT p.Name, p.Link FROM exercise e JOIN exercise_playlist p ON e.sno = p.scid WHERE p.scid = '{$_GET['id']}' ";
                $result=mysqli_query($con,$sql);
                if($result){
